...
var ɵNgxsAppBootstrappedState = class _ɵNgxsAppBootstrappedState extends import_rxjs2.ReplaySubject {
  constructor() {
    super(1);
  }
  bootstrap() {
...
var InternalActions = class _InternalActions extends ɵOrderedSubject {
  constructor() {
    super();
    this.dispatched$ = new import_rxjs3.Subject();
    this.pipe((0, import_rxjs3.filter)(
...
var Actions = class _Actions extends import_rxjs3.Observable {
  constructor() {
...
function installOnUnhandhedErrorHandler() {
  ...
  const existingHandler = import_rxjs3.config.onUnhandledError;
...
var InternalDispatchedActionResults = class _InternalDispatchedActionResults extends import_rxjs3.Subject {
  static {
    this.ɵfac = /* @__PURE__ */ (() => {
...
var InternalDispatcher = class _InternalDispatcher {
  ...
  createDispatchObservable(actionResult$) {
    return actionResult$.pipe((0, import_operators2.mergeMap)((ctx) => {
      switch (ctx.status) {
        case "SUCCESSFUL":
    ...
    }), (0, import_operators2.shareReplay)());
  }
  static {
...
var StateFactory = class _StateFactory {
  ...
  connectActionHandlers() {
    this._actionsSubscription = this._actions.pipe((0, import_rxjs3.filter)(
      (ctx) => ctx.status === "DISPATCHED"
      /* ActionStatus.Dispatched */
    ), (0, import_rxjs3.mergeMap)((ctx) => {
      const action = ctx.action;
      return this.invokeActions(action).pipe((0, import_rxjs3.map)(() => ({
        action,
        status: "SUCCESSFUL"
        /* ActionStatus.Successful */
      })), (0, import_rxjs3.defaultIfEmpty)({
        action,
        status: "CANCELED"
        /* ActionStatus.Canceled */
  ...
  invokeActions(action) {
    ...
    if (actionHandlers) {
      for (const actionHandler of actionHandlers) {
        ...
        try {
          ...
          result = (0, import_rxjs3.throwError)(() => e);
        }
        results.push(result);
    ...
    if (!results.length) {
      results.push((0, import_rxjs3.of)(void 0));
    }
      ...
      const actionHandlers = actions[actionType].map((actionMeta) => {
        ...
        return (action) => {
          ...
          if ((0, import_rxjs3.isObservable)(result)) {
            result = result.pipe(
              (0, import_rxjs3.mergeMap)((value) => {
                if (isPromise(value)) {
                  return (0, import_rxjs3.from)(value);
                } else if ((0, import_rxjs3.isObservable)(value)) {
                  return value;
                } else {
              ...
              (0, import_rxjs3.defaultIfEmpty)(void 0)
            );
            if (cancelable) {
              const notifier$ = dispatched$.pipe(ofActionDispatched(action));
              result = result.pipe((0, import_rxjs3.takeUntil)(notifier$));
            }
            result = result.pipe(
            ...
            result = (0, import_rxjs3.of)(void 0);
          }
          return result;
        };
      });
